...
namespace TeamBuilder.Services
{
    public static class Constants
    {
        ...
        public static class ErrorMessages
        {
            ...
            public const string InvalidCommand = "{0} is not a valid command!";
        ...
        {
            public const string RegistrationSuccessfull = "User {0} was registered successfully!";

            public const string LogInSuccessfull = "User {0} successfully logged in!";
